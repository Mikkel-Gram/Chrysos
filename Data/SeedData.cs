...
public static class SeedData
{
    ...
    public static List<Exercise> Exercises() => new()
    {
        ...
        Ex("Hanging Straight Leg Raise", ExerciseCategory.Strength, IntensityLevel.VeryHard, MuscleGroup.Core, SpecificMuscle.Abs, false, 30,
            "Hang from a pull-up bar and raise straight legs to hip height or higher, then lower with control.", Equipment.PullUpBar),
        ...
        Ex("Sumo Squat", ExerciseCategory.Strength, IntensityLevel.Moderate, MuscleGroup.LowerBody, SpecificMuscle.Adductors, false, 45,
            "Take a wide stance with toes turned out, squat straight down, and stand up by driving through the feet."),
        Ex("Squat Pulse", ExerciseCategory.Strength, IntensityLevel.Hard, MuscleGroup.LowerBody, SpecificMuscle.Quadriceps, false, 35,
            "Stay low in the squat and pulse up and down through a small controlled range."),
        ...
        Ex("Forward Lunge", ExerciseCategory.Strength, IntensityLevel.Moderate, MuscleGroup.LowerBody, SpecificMuscle.Quadriceps, true, 40,
            "Step forward and lower until both knees bend, then push back to the start."),
        ...
        Ex("Side-Lying Clamshell", ExerciseCategory.Strength, IntensityLevel.Light, MuscleGroup.LowerBody, SpecificMuscle.Abductors, true, 35,
            "Lying on your side with knees bent, keep feet together and open the top knee like a shell.", Equipment.Mat),
        Ex("Side-Lying Knee Tuck to Kick", ExerciseCategory.Strength, IntensityLevel.Moderate, MuscleGroup.LowerBody, SpecificMuscle.Glutes, true, 35,
            "On your side, bring the top knee in, then press the leg long before returning with control.", Equipment.Mat),
        Ex("Side-Lying Leg Circles", ExerciseCategory.Strength, IntensityLevel.Light, MuscleGroup.LowerBody, SpecificMuscle.Abductors, true, 35,
            "Lying on your side with the top leg long, draw controlled circles in both directions.", Equipment.Mat),
        Ex("Band Donkey Kick", ExerciseCategory.Strength, IntensityLevel.Moderate, MuscleGroup.LowerBody, SpecificMuscle.Glutes, true, 40,
            "From all fours with a resistance band, press one heel back and up while keeping the hips level.", Equipment.ResistanceBand, Equipment.Mat),
        Ex("Lateral Lunge", ExerciseCategory.Strength, IntensityLevel.Moderate, MuscleGroup.LowerBody, SpecificMuscle.Adductors, true, 40,
            "Step out to the side, sit into the working hip, then drive back to the center."),
        Ex("Kettlebell Lateral Lunge", ExerciseCategory.Strength, IntensityLevel.Hard, MuscleGroup.LowerBody, SpecificMuscle.Adductors, true, 40,
            "Hold the kettlebell at the chest, step wide and sink into one hip, then return to center.", Equipment.Kettlebell),
        Ex("Band Leg Press", ExerciseCategory.Strength, IntensityLevel.Moderate, MuscleGroup.LowerBody, SpecificMuscle.Quadriceps, true, 40,
            "Lying on your back with the band under the foot, press the leg out long and control the return.", Equipment.ResistanceBand, Equipment.Mat),
        ...
        Ex("Ring Plank", ExerciseCategory.Strength, IntensityLevel.Hard, MuscleGroup.Core, SpecificMuscle.Abs, false, 35,
            "Place forearms or hands in gym rings and hold a rigid plank while resisting swing.", Equipment.GymRings),
        ...
        Ex("Atomic Sit-Up", ExerciseCategory.Strength, IntensityLevel.Hard, MuscleGroup.Core, SpecificMuscle.Abs, false, 35,
            "Lie on your back and perform a full sit-up, then control back down with the core braced.", Equipment.Mat),
        ...
        Ex("Dumbbell Lateral Raise", ExerciseCategory.Strength, IntensityLevel.Moderate, MuscleGroup.UpperBody, SpecificMuscle.Shoulders, false, 35,
            "Raise the dumbbells out to shoulder height with a slight bend in the elbows.", Equipment.Dumbbells),
        Ex("Dumbbell Front Raise", ExerciseCategory.Strength, IntensityLevel.Moderate, MuscleGroup.UpperBody, SpecificMuscle.Shoulders, false, 35,
            "Raise the dumbbells in front to shoulder height without leaning back.", Equipment.Dumbbells),
        ...
        Ex("Prone Dumbbell Snow Angel", ExerciseCategory.Strength, IntensityLevel.Moderate, MuscleGroup.UpperBody, SpecificMuscle.UpperBack, false, 40,
            "Lie face down holding light dumbbells and sweep straight arms from the sides to overhead close to the floor.", Equipment.Dumbbells, Equipment.Mat),
        Ex("Ring Row (Wide Grip)", ExerciseCategory.Strength, IntensityLevel.Moderate, MuscleGroup.UpperBody, SpecificMuscle.UpperBack, false, 40,
            "Hang from gym rings with a wide grip and row your chest up while keeping the body straight.", Equipment.GymRings),
        Ex("Ring Row (Narrow Grip)", ExerciseCategory.Strength, IntensityLevel.Moderate, MuscleGroup.UpperBody, SpecificMuscle.UpperBack, false, 40,
            "Hang from gym rings with a close grip and row the chest towards the hands.", Equipment.GymRings),
        ...
        Ex("Single-Arm Kettlebell Biceps Curl", ExerciseCategory.Strength, IntensityLevel.Moderate, MuscleGroup.UpperBody, SpecificMuscle.Biceps, true, 35,
            "Curl one kettlebell at a time with the elbow close to the body and lower slowly.", Equipment.Kettlebell),
        Ex("Ring Chin-Up", ExerciseCategory.Strength, IntensityLevel.VeryHard, MuscleGroup.UpperBody, SpecificMuscle.Biceps, false, 30,
            "With palms facing you on gym rings, pull until the chin clears the hands under control.", Equipment.GymRings),
        Ex("Ring Pull-Up", ExerciseCategory.Strength, IntensityLevel.VeryHard, MuscleGroup.UpperBody, SpecificMuscle.Lats, false, 30,
            "With an overhand grip on gym rings, pull the chest up and lower slowly.", Equipment.GymRings),
        Ex("T Push-Up", ExerciseCategory.Strength, IntensityLevel.Hard, MuscleGroup.UpperBody, SpecificMuscle.Chest, true, 40,
            "Perform a push-up, then rotate into a side plank reaching the top arm up before alternating sides.", Equipment.Mat),
        Ex("Ring Push-Up", ExerciseCategory.Strength, IntensityLevel.Hard, MuscleGroup.UpperBody, SpecificMuscle.Chest, false, 40,
            "Hands in gym rings, lower the chest between the hands and press back up while stabilizing.", Equipment.GymRings),
        Ex("Dumbbell Overhead Triceps Extension", ExerciseCategory.Strength, IntensityLevel.Moderate, MuscleGroup.UpperBody, SpecificMuscle.Triceps, false, 40,
            "Hold one dumbbell overhead, bend the elbows to lower behind the head, then extend fully.", Equipment.Dumbbells),
        Ex("Goblet Squat", ExerciseCategory.Strength, IntensityLevel.Moderate, MuscleGroup.LowerBody, SpecificMuscle.Quadriceps, false, 45,
            "Hold a weight at the chest and squat deep with an upright torso.", Equipment.Kettlebell),
        ...
        Ex("Single-Leg Romanian Deadlift", ExerciseCategory.Strength, IntensityLevel.Hard, MuscleGroup.LowerBody, SpecificMuscle.Hamstrings, true, 40,
            "Hinge on one leg with a long spine, then drive the standing leg through to return upright."),
        Ex("Kettlebell Deadlift", ExerciseCategory.Strength, IntensityLevel.Moderate, MuscleGroup.LowerBody, SpecificMuscle.Hamstrings, false, 45,
            "Stand over the kettlebell, brace, hinge down and drive through the feet to stand tall.", Equipment.Kettlebell),
        ...
        Ex("Burpee with Push-Up", ExerciseCategory.Cardio, IntensityLevel.VeryHard, MuscleGroup.FullBody, SpecificMuscle.Cardiovascular, false, 40,
            "Perform a burpee adding a full push-up in the plank phase before jumping back in.", Equipment.Mat),
    ...
    public static List<Combo> Combos() => new()
    {
        ...
        new Combo
        {
            Id = StableId("combo:Side-Lying Glute Activation Combo"),
            Name = "Side-Lying Glute Activation Combo",
            Description = "Complete all three side-lying glute moves on one side before switching.",
            IsBuiltIn = true,
            Alternating = true,
            Items = new List<ComboItem> { Item("Side-Lying Clamshell"), Item("Side-Lying Knee Tuck to Kick"), Item("Side-Lying Leg Circles") }
        }
    };
}
